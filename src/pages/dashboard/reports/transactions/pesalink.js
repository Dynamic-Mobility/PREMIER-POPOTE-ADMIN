...
import {
    setPageSize,
    setActivePage,
    fetchPesalinkTransactions,
    resetFilters,
    setFilters,
} from "../../../../slices/dashboard/transactions/pesalink-transactions";
...
const title = "Pesalink Transactions";

const PesalinkTransactionPage = () => {
    const dispatch = useDispatch();
    const authUser = useAuth();

    const {
        pesalinkTransactions,
        filters,
        pageSize,
        activePage,
        totalRecords
    } = useSelector(({ pesalinkTransactions }) => pesalinkTransactions);
...
PesalinkTransactionPage.getLayout = (page) => (
    <AuthGuard>
        <ModernLayout>
            {page}
        </ModernLayout>
...
export default PesalinkTransactionPage;
