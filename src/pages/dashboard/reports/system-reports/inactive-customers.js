...
const InactiveCustomersPage = () => {
    ...
    const { inactiveCustomers, pageSize, currentPage} = useSelector(( { customers }) => customers);
    ...
    const handleOnResetFilters = async () => {
        ...
        await dispatch(getInactiveCustomers(authUser,values ))
    }
    ...
    return (
        <>
            ...
            >
                ...
                <Card sx={{ p: 1 }}>
                    <ExistingCustomersDatagrid data={inactiveCustomers} />
                </Card>
            </MKBox>
