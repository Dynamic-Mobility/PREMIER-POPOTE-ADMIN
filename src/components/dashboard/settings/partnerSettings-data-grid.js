...
import AddPartner from "../../../pages/dashboard/settings/addPartner";
import {
  Grid,
  Autocomplete,
  TextField,
...
const PartnerSettingsDataGrid = (props) => {
        ...
        {value === 0 && (
          <>
            ...
            >
              ...
              <Column dataField="amount" caption="PartnerCode" />
              <Column dataField="transaction" caption="SourceIp" />
              <Column dataField="client" caption="Status" />
              <Column dataField="reference" caption="Access Control" />
              <Toolbar>
...
export default PartnerSettingsDataGrid;
